        ...
        <div class="col-12">
            <form class="form-horizontal" method="POST" action="{{ route('customer.store') }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-12 col-md-8 col-lg-9">
                        <input id="phone" type="text" placeholder="1234567890" minlength="8" maxlength="10" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ old('phone') }}" autofocus>
