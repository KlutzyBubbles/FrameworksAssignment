...
@section('content')
    <div class="row">
        <div class="col-12">
            <h1 class="text-nowrap text-left">Edit Tour</h1>
        </div>
    </div>
    <hr>
    <div class="row">
        <div class="col-12">
            <form class="form-horizontal" method="POST" action="{{ route('tour.update', ['id' => $data->id]) }}">
                @method('PUT')
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-12 col-md-8">
                        <input id="name" type="text" placeholder="Example Name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name', $data->name) }}" required autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-12 col-md-8">
                        <input id="duration" type="number" step="0.1" min="0" placeholder="4.5" class="form-control{{ $errors->has('duration') ? ' is-invalid' : '' }}" name="duration" value="{{ old('duration', $data->duration) }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-12 col-md-8">
                        <input id="route_map" type="text" placeholder="https://www.domain.ext/image-name.img-extension" class="form-control{{ $errors->has('route_map') ? ' is-invalid' : '' }}" name="route_map" value="{{ old('route_map', $data->route_map) }}">
